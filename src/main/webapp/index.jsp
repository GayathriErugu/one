    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root {
            ...
            --radius: 18px;
            --radius-sm: 10px;
            --shadow: 0 6px 28px rgba(30, 30, 42, 0.06);
            --shadow-hover: 0 16px 48px rgba(30, 30, 42, 0.10);
        ...
        .btn-primary:hover { background: var(--accent-dark); border-color: var(--accent-dark); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(217,108,90,0.30); }
        .btn-secondary { background: var(--primary); color: #fff; border-color: var(--primary); }
        .btn-secondary:hover { background: var(--primary-light); border-color: var(--primary-light); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(30,30,42,0.20); }
        ...
        .btn-ghost:hover { background: rgba(255,255,255,0.22); border-color: rgba(255,255,255,0.35); transform: translateY(-2px); }
        ...
        .search-wrap:focus-within {
            ...
            box-shadow: 0 0 0 4px rgba(217,108,90,0.10);
        }
        .search-wrap input {
        ...
        .hero {
            ...
            margin: 20px 24px 0;
            background: linear-gradient(135deg, #1c1c2e 0%, #2c2c44 100%);
        }
        .hero::before {
        ...
        .hero .badge {
            display: inline-block; background: rgba(217,108,90,0.20);
        ...
        .newsletter-wrap form input {
            ...
            border: 0; font-size: 15px; background: rgba(255,255,255,0.12);
